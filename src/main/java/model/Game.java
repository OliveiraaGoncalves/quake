...
public class Game {
    ...
    public Game(int id) {
        ...
        this.worldScore = 0;  // INICIALIZA A PONTUACAO DE MORTES PELO CENARIO COM 0
        this.id = "game_" + id;
    }
    ...
    // INCREMENTA MAIS 1 NA PONTUACAO TOTAL DO JOGO
    ...
    // INCREMENTA MAIS 1 NA PONTUACAO DE MORTES POR CENARIO NO JOGO
    ...
    public void addPlayer(Player player) {
        for (int i = 0; i < players.size(); i++) {
            if (players.get(i).getNickName().equals(player.getNickName())) { // NAO PERMITE NOMES DE JOGADORES REPETIDOS
    ...
    /*
     * ESTE METODO TEM POR OBJETIVO DEFINIR O TIPO DE MORTE SOFRIDA PELO JOGADOR
     * O PARAMETRO LINE REPRESENTA A LINHA DO ARQUIVO GAMES.LOG
     * O PARAMETRO PLAYERNICKNAME REPRESENTA O NOME DO JOGADOR QUE MORREU
     */
    ...
    /*
     * ESTE METODO TEM POR OBJETIVO DEFINIR O TIPO DE MORTE SOFRIDA DE UM JOGADOR POR OUTRO
     * O PARAMETRO LINE REPRESENTA A LINHA DO ARQUIVO GAMES.LOG
     * O PARAMETRO PLAYERNICKNAME REPRESENTA O NOME DO JOGADOR QUE MATOU
     * O PARAMETRO PLAYERKILLEDNICKNAME REPRESENTA O NOME DO JOGADOR QUE MORREU
     */
    ...
    /*
     *  IMPRIME A PONTUACAO DE CADA JOGADOR DE FORMA ORGANIZADA
     */
